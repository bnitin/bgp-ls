...
import org.topology.bgp_ls.config.nodes.AddressFamilyRoutingPeerConfiguration;
...
public class AddressFamilyRoutingPeerConfigurationImpl implements AddressFamilyRoutingPeerConfiguration {
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.AddressFamilyRoutingPeerConfiguration#getAddressFamilyKey()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.AddressFamilyRoutingPeerConfiguration#getLocalDefaultPathAttributes()
	 */
	
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.AddressFamilyRoutingPeerConfiguration#getLocalRoutingFilters()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.AddressFamilyRoutingPeerConfiguration#getRemoteRoutingFilters()
	 */
	@Override
