...
public class FixedDefaultsPeerConfigurationTimer implements
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.PeerConfigurationTimer#getHoldTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.PeerConfigurationTimer#getIdleHoldTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.PeerConfigurationTimer#getDelayOpenTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.PeerConfigurationTimer#getConnectRetryTime()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.PeerConfigurationTimer#getAutomaticStartInterval()
	 */
	@Override
