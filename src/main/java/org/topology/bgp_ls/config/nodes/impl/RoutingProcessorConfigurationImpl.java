...
import org.topology.bgp_ls.config.nodes.RoutingInstanceConfiguration;
...
class RoutingProcessorConfigurationImpl implements RoutingProcessorConfiguration {
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.config.nodes.RoutingProcessorConfiguration#getRoutingInstances()
	 */
	@Override
