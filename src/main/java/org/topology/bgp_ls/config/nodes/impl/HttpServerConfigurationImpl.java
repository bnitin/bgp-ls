 ...
 * 
 * File: org.bgp4.config.impl.HttpServerConfigurationImpl.java 
 */
/**
 ...
 *
 */
public class HttpServerConfigurationImpl extends ServerConfigurationImpl {

    private static final int HTTP_NON_ROOT_PORT = 8080;

	public HttpServerConfigurationImpl() {
        super.setPort(HTTP_NON_ROOT_PORT);
    }
