 ...
 *  
 */
package org.topology.bgp_ls.net.capabilities;
...
public class OutboundRouteFilteringCapability extends Capability {
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.netty.protocol.Capability#encodeParameterValue()
	 */
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.net.Capability#orderNumber()
	 */
	@Override
