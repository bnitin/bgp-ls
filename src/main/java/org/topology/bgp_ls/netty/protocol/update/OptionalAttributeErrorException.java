 ...
 * 
 * File: org.topology.bgp_ls.netty.protocol.UnrecognizedAttributeException.java 
 */
...
public class OptionalAttributeErrorException extends AttributeException {
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.netty.protocol.ProtocolPacketException#toNotificationPacket()
	 */
	@Override
