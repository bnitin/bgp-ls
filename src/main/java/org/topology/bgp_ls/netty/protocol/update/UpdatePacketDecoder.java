 ...
 * 
 * File: org.topology.bgp_ls.netty.protocol.update.UpdatePacketDecoder.java 
 */
/**
...
import org.topology.bgp_ls.net.PathSegment;
import org.topology.bgp_ls.net.SubsequentAddressFamily;
import org.topology.bgp_ls.net.attributes.ASPathAttribute;
import org.topology.bgp_ls.net.attributes.AggregatorPathAttribute;
...
import org.topology.bgp_ls.net.attributes.LocalPrefPathAttribute;
...
import org.topology.bgp_ls.net.attributes.OriginPathAttribute;
import org.topology.bgp_ls.net.attributes.OriginatorIDPathAttribute;
import org.topology.bgp_ls.net.attributes.PathAttribute;
import org.topology.bgp_ls.net.attributes.PathAttributeType;
import org.topology.bgp_ls.net.attributes.UnknownPathAttribute;
import org.topology.bgp_ls.netty.BGPv4Constants;
import org.topology.bgp_ls.netty.NLRICodec;
...
import org.topology.bgp_ls.netty.protocol.ProtocolPacketUtils;
...
public class UpdatePacketDecoder {
	...
	private static NLRICodec codec = (NLRICodec)SingletonRegistry.getInstance(NLRICodec.class.getName());
	...
	private MultiProtocolNLRI decodeMpNlriPathAttribute(int type, ChannelBuffer buffer) {
		...
		try {
			...
			mpcodec = (MultiProtocolNLRICodec)SingletonRegistry.getInstance(classname);
		} catch (Exception e) {
	...
	private PathAttribute decodeLinkStateAttribute(ChannelBuffer buffer) {
		...
		lscodec = (LinkStateAttributeCodec)SingletonRegistry.getInstance(LinkStateAttributeCodec.class.getName());
