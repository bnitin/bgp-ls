 ...
 * 
 * File: org.topology.bgp_ls.netty.protocol.ConnectionNotSynchronizedException.java 
 */
...
public class ConnectionNotSynchronizedException extends
	...
	/* (non-Javadoc)
	 * @see org.topology.bgp_ls.netty.protocol.ProtocolPacketFormatException#toNotificationPacket()
	 */
	@Override
