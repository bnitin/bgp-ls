...
import org.topology.bgp_ls.netty.handlers.BGPv4ClientEndpoint;
...
public class BGPv4Client {
    ...
    public BGPv4Client () {
        ...
        clientEndpoint = (BGPv4ClientEndpoint)SingletonRegistry.getInstance(BGPv4ClientEndpoint.class.getName());
